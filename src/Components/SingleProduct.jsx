        ...
        <div className="row">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img
                    ...
                    src={`/assets/productimages/${p.pic1}`}
                    height="550px"
                    alt="First slide"
                  />
                </div>
                <div className="carousel-item">
                  <img
                    className="d-block w-100"
                    src={`/assets/productimages/${p.pic2}`}
                    height="550px"
                    alt="Second slide"
                  />
                </div>
                <div className="carousel-item">
                  <img
                    className="d-block w-100"
                    src={`/assets/productimages/${p.pic3}`}
                    height="550px"
                    alt="Third slide"
                  />
                </div>
                <div className="carousel-item">
                  <img
                    className="d-block w-100"
                    src={`/assets/productimages/${p.pic4}`}
                    height="550px"
                    alt="Third slide"
                  />
                </div>
          ...
          <div className="col-md-7">
            ...
            <div className="mb-5 d-flex justify-content-between">
              <div className="input-group mb-3" style={{ maxWidth: "32%" }}>
                ...
                <div className="input-group-append">
                  <button
                    ...
                    type="button"
                    onClick={()=>setq(Number(q)+1)}
                  >
                    +
                  </button>
                </div>
              </div>
              <div style={{ maxWidth: "67%" }} className="d-flex justify-content-between">
              <p>
              <button className="buy-now btn btn-sm btn-primary" onClick={addToCart}>
                Add To Cart
              </button>
            </p>
              </div>
              <div>
              <p>
              <button className="buy-now btn btn-sm btn-primary" onClick={addToWishlist}>
                Add To WishList
              </button>
            </p>
              </div>
