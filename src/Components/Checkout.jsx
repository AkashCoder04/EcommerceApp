        ...
        <div className="row">
          <div className="col-md-6 mb-5 mb-md-0">
            ...
            <div className="p-3 p-lg-5 border">
              ...
              <div className="form-group">
                <label htmlFor="c_create_account" className="text-black" data-toggle="collapse" to="#create_an_account" role="button" aria-expanded="false" aria-controls="create_an_account"><input type="checkbox" value="1" id="c_create_account"/> Create an account?</label>
              ...
              <div className="form-group">
                <label htmlFor="c_ship_different_address" className="text-black" data-toggle="collapse" to="#ship_different_address" role="button" aria-expanded="false" aria-controls="ship_different_address"><input type="checkbox" value="1" id="c_ship_different_address"/> Ship To A Different Address?</label>
              ...
              <div className="col-md-12">
                ...
                <div className="p-3 p-lg-5 border">
                  ...
                  <div className="border p-3 mb-3">
                    <h3 className="h6 mb-0"><Link className="d-block" data-toggle="collapse" to="#collapsebank" role="button" aria-expanded="false" aria-controls="collapsebank">Direct Bank Transfer</Link></h3>
                  ...
                  <div className="border p-3 mb-3">
                    <h3 className="h6 mb-0"><Link className="d-block" data-toggle="collapse" to="#collapsecheque" role="button" aria-expanded="false" aria-controls="collapsecheque">Cheque Payment</Link></h3>
                  ...
                  <div className="border p-3 mb-5">
                    <h3 className="h6 mb-0"><Link className="d-block" data-toggle="collapse" to="#collapsepaypal" role="button" aria-expanded="false" aria-controls="collapsepaypal">Paypal</Link></h3>
                  ...
                  <div className="form-group">
                    <button className="btn btn-primary btn-lg py-3 btn-block" onClick={()=>window.location='/confirmation'}>Place Order</button>
                  </div>
