        ...
        <div className="row mb-5">
          <div className="col-md-6">
            <div className="block-16">
              <figure>
                <img src="assets/images/blog_1.jpg" alt="" className="img-fluid rounded"/>
        ...
        <div className="row">
            ...
            <div className="block-38 text-center">
              <div className="block-38-img">
                <div className="block-38-header">
                  <img src="assets/images/person_1.jpg" alt="" className="mb-4"/>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="block-38 text-center">
              <div className="block-38-img">
                <div className="block-38-header">
                  <img src="assets/images/person_2.jpg" alt="" className="mb-4"/>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="block-38 text-center">
              <div className="block-38-img">
                <div className="block-38-header">
                  <img src="assets/images/person_3.jpg" alt="" className="mb-4"/>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="block-38 text-center">
              <div className="block-38-img">
                <div className="block-38-header">
                  <img src="assets/images/person_4.jpg" alt="" className="mb-4"/>
